...
메뉴제목:
<br>
<input type="text" name="title" class="form-control menuInput mt-2" placeholder="메뉴제목을 적어주세요" value="<%=product.get("MNAME")%>">
<br>
메뉴 STITLE:
<br>
 <input type="text" name="stitle" class="form-control menuInput mt-2" placeholder="메뉴stitle을 적어주세요" value="<%=product.get("STITLE")%>">
<br>
메뉴 ITITLE: 
<br>
<input type="text" name="ititle" class="form-control menuInput mt-2" placeholder="메뉴ititle을 적어주세요" value="<%=product.get("ITITLE")%>">
<br>
메뉴 사이즈 
<br>
대문자로 적어주세요
<br>
<input type="text" name="size" class="form-control menuInput mt-2" placeholder="사용가능 사이즈를 적어주세요" value="<%=product.get("MSIZE")%>">
<br>
메뉴 엣지
<br>
<input type="text" name="edge" class="form-control menuInput mt-2" placeholder="사용가능 엣지를 적어주세요" value="<%=product.get("EDGE")%>">
메뉴 내용 
<br>
...
<br>
<input type="text" name="price" class="form-control menuInput mt-2" placeholder="가격을 적어주세요"  value="<%=product.get("PRICE")%>">
<br>
일 최대 판매량을 입력해주세요
<br>
